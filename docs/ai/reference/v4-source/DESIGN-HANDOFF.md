# 6543cce5-bae1-44bd-99c5-c7855804db0e implementation handoff
...
- `mpme2nl9-drawing-2026-05-26T08-44-22-888Z.png`
- `mpmeb36r-image.png`
- `mpmfua95-image.png`
- `mpmfumgy-image.png`
- `mpmfuphv-image.png`
...
- `screenshots/03-project-pixel2-preview.png`
- `screenshots/04-project-pixel2-tasks.png`
- `screenshots/05-project-pixel2-graph.png`
- `screenshots/06-project-pixel2-deliveries.png`
- `screenshots/07-project-pixel2-memory.png`
- `screenshots/08-project-pixel2-activity.png`
- `screenshots/09-project-pixel2-editor.png`
- `screenshots/10-project-pixel2-inspect.png`
- `screenshots/12-agent-aria.png`
- `screenshots/13-settings.png`
- `screenshots/14-new-project-modal.png`
- `screenshots/15-plugins-installed.png`
- `screenshots/16-plugins-sources.png`
- `screenshots/17-integrations-mcp.png`
- `screenshots/18-integrations-connectors.png`
- `screenshots/19-integrations-anywhere.png`
